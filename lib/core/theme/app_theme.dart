  ...
  static ThemeData _build(ColorScheme cs, Color scaffoldBg) {
    ...
    return ThemeData(
      ...
      appBarTheme: AppBarTheme(
        ...
        shadowColor: cs.outline.withOpacity(0.1),
      ...
      cardTheme: CardTheme(
        ...
        shape: RoundedRectangleBorder(
          ...
          side: BorderSide(color: cs.outline.withOpacity(isDark ? 0.2 : 0.12)),
        ),
      ...
      inputDecorationTheme: InputDecorationTheme(
        filled: true,
        fillColor: cs.surfaceContainerHighest.withOpacity(isDark ? 0.5 : 0.35),
        contentPadding: const EdgeInsets.symmetric(horizontal: 16, vertical: 16),
        border: OutlineInputBorder(borderRadius: BorderRadius.circular(14), borderSide: BorderSide(color: cs.outline.withOpacity(0.25))),
        enabledBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(14), borderSide: BorderSide(color: cs.outline.withOpacity(0.25))),
        ...
        hintStyle: GoogleFonts.inter(color: cs.onSurfaceVariant.withOpacity(0.55), fontSize: 14),
      ...
      dividerTheme: DividerThemeData(color: cs.outline.withOpacity(0.12), thickness: 1, space: 1),
