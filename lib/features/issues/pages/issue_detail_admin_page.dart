import 'package:civic_connect/features/issues/pages/reassignment_timeline_page.dart';
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildInfoRow("Department", data['assignedToDept']?.toUpperCase() ?? 'N/A'),
          ...
          children: [
            ...
            if (data['audioUrl'] != null)
              const ListTile(
                ...
                title: Text("Audio Evidence Attached"),
              ),
            if (data['videoUrl'] != null)
              const ListTile(
                leading: Icon(Icons.videocam, color: Colors.red),
                title: Text("Video Evidence Attached"),
              ),
          ],
        ),
      ),
  ...
  Future<void> _reassignIssue(String fromDept, String toDept, String reason) async {
    ...
    await FirebaseFirestore.instance.runTransaction((txn) async {
      txn.update(issueRef, {
        ...
        "lastReassignedBy": FirebaseAuth.instance.currentUser!.uid,
      });
